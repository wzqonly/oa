...
KISBPM.TOOLBAR = {
    ACTIONS: {
        ...
        closeEditor: function(services) {
        	window.location.href = '/workflowAction_workflow.action';
        },
...
var SaveModelCtrl = [ '$rootScope', '$scope', '$http', '$route', '$location',
    ...
    $scope.save = function (successCallback) {
        ...
        var params = {
            'modelBean.jsonXml': json,
            'modelBean.svgXml': svgDOM,
            'modelBean.name': $scope.saveDialog.name,
            'modelBean.description': $scope.saveDialog.description
        };
